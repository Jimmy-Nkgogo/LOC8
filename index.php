...
<body>
    <header>
        ...
        <section class="menu">
            <nav>
                <ul id='MenuItems'>
                    <li><a href='C:\Users\Caleb.jr\Desktop\login page 2\meet our-team-section-ap30-master\our-team-section-ap30-master\index.html'>Home</a></li>
    ...
    <section class="main">
        ...
        <section class="left">
            <p class="title">A trusted provider
                of skilled labour</p>
            <p class="msg">A trusted Provider of in demand
                skill sets.you just have to
                LOC8 them</p>
                <button class="truck-button">
                    <span class="default">Order Service</span>
                    <span class="success">
                        Let's Go
        ...
        <section class="right">
            ...
            <lottie-player src="https://assets6.lottiefiles.com/packages/lf20_teqtg9.json"  
            background="transparent" speed="1" style="width: 500px; height: 300px;" loop autoplay></lottie-player>
          </section>
        ...
        <div class="panel bottom">
            <div class="content">
                <div class="description">
                    ...
                    <br>
                    <br>
                    <p>Limited employment opportunities</p> <br>
                    <p>Low-quality housing</p><br>
                    <p>Fewer available recreational activities</p><br>
                </div>
    ...
    <div class="container">
        <section class="left2">
            <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
            <lottie-player src="https://assets6.lottiefiles.com/packages/lf20_jtbfg2nb.json"  
            background="transparent" speed="1" style="width: 500px; height: 500px;" loop autoplay></lottie-player>
        </section>
        <section class="right2">
            <div class="tt">
                <h2>Levels Of Services</h2>
                <br>
                <p>We've got you covered in ways possible with Loc8 Provides all four levels of labours which are your:
